...
void InputViewComponent::Rebuild()
{
  ...
  // Build the statuBox
  m_StatusBox = new Fl_Button(m_LeftMargin + m_CentralWidgetsLength + m_WidgetsMargin,
                              this->y() + m_UpperMargin, 60, m_SimpleWidgetsHeight);
  ...
  m_ProgressBar = new Fl_Progress(m_LeftMargin,
                                  this->y() + m_UpperMargin + m_SimpleWidgetsHeight, m_CentralWidgetsLength, 15);
  ...
  if (m_InputDataDescriptor.IsMultiple())
    {
    // Build the browser
    m_FlBrowser = new Fl_Browser(m_LeftMargin,
                                 this->y() + m_UpperMargin + m_SimpleWidgetsHeight + 2 * m_WidgetsMargin,
                                 m_CentralWidgetsLength,
                                 m_MultipleWidgetsHeight);
    ...
    m_AddButton = new Fl_Button(m_LeftMargin + m_CentralWidgetsLength + m_WidgetsMargin + 10,
                                this->y() + m_SimpleWidgetsHeight + 1 * m_MultipleWidgetsHeight / 3, 20, 20, "+");
    ...
    m_RemoveButton = new Fl_Button(m_LeftMargin + m_CentralWidgetsLength + m_WidgetsMargin + 10,
                                   this->y() + m_SimpleWidgetsHeight + 2 * m_MultipleWidgetsHeight / 3, 20, 20, "-");
    ...
    m_ClearButton = new Fl_Button(m_LeftMargin + m_CentralWidgetsLength + m_WidgetsMargin,
                                  this->y() + m_SimpleWidgetsHeight + 3 * m_MultipleWidgetsHeight / 3, 40,
                                  m_SimpleWidgetsHeight, "Clear");
