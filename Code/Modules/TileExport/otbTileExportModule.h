...
public:
  ...
  // Intensity Rescale
  typedef VectorRescaleIntensityImageFilter<FloatingVectorImageType, FloatingVectorImageType> VectorRescaleIntensityImageFilterType;
...
private:
  ...
  void GenerateKMLExtended(std::string pathname, int depth, int x, int y, OutputPointType lowerLeft, OutputPointType lowerRight, OutputPointType upperRight, OutputPointType upperLeft);
  ...
  /**
    ...
    */
  void AddNetworkLinkToRootKML(double north, double south, double east, double west, std::string directory, bool addRegion , unsigned int pos);
