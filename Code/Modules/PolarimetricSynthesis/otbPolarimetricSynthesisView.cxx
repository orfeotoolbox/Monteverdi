...
void PolarimetricSynthesisView::VectorBrowserCallback()
{
  ...
  fVectorInputImage->value(filename);
}
void PolarimetricSynthesisView::HHBrowserCallback()
{
  const char * filename = NULL;
  ...
  fHHInputImage->value(filename);
}
void PolarimetricSynthesisView::HVBrowserCallback()
{
  const char * filename = NULL;
  ...
  fHVInputImage->value(filename);
}
void PolarimetricSynthesisView::VHBrowserCallback()
{
  const char * filename = NULL;
  ...
  fVHInputImage->value(filename);
}
void PolarimetricSynthesisView::VVBrowserCallback()
{
  const char * filename = NULL;
