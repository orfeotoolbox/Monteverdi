 ...
 *  \brief This class read a file that contains spectral sensitivity values and fill a structure that contains man and max wavelengths, the coefficients list and the step.
 *
 */
...
public:
 ...
 /** Creation through the object factory */
  ...
  typedef ObjectList<FilterFunctionValues>           WavelenghtSpectralBandVectorType;
  typedef WavelenghtSpectralBandVectorType::Pointer  WavelenghtSpectralBandVectorPointerType;
  ...
  /** Overide of the GetOutput() method */
  virtual WavelenghtSpectralBandVectorType * GetOutput(void);
  virtual const WavelenghtSpectralBandVectorType * GetOutput(void) const;
