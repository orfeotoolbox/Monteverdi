...
public:
  ...
  typedef EdgeDensityImageFilter<SingleImageType, SingleImageType, CannyDetectorType  ,CountFunctionType>  CannyEdgeDensityFilterType;
  typedef EdgeDensityImageFilter<SingleImageType, SingleImageType, SobelDetectorType  ,CountFunctionType>  SobelEdgeDensityFilterType;
  ...
  SingleImagePointerType GenerateEdgeDensityOutputImage( ModelPointerType pModel,  FeatureType pType, unsigned int pInputListId  )
  {
