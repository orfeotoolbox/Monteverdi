...
int main(int argc, char* argv[])
{
  ...
  otb::TypeManager::GetInstance()->RegisterType<otb::ExampleModule::FloatingPointSetType>("Floating_Point_PointSet");
  ...
  model->RegisterModule<otb::ExampleModule>("Example","ExampleMenu/ExampleSubMenu/Example");
